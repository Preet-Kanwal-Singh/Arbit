"""Provenance stamper for Tier B Z-score clip isolation."""
...
def main():
    ...
    provenance = {
        "claim_id": "wq_zscore_clip_isolation_v0",
        "phase": "phase_ii_rl_agent_tcs_infy",
        "tier": "B",
        "snapshot_id": "tcs_infy_v4_2026-07-13",
        "synthetic": False,
        "script_path": str((OUT_DIR / "clip_isolation.py").relative_to(ROOT)).replace("\\", "/"),
