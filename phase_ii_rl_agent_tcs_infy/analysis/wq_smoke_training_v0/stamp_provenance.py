...
def main() -> None:
    # Instead of run_log*.txt, we can just hash summary.md and the tfevents file
    summary_file = OUT_DIR / "summary.md"
    tb_files = sorted(OUT_DIR.glob("tb/**/events.out.tfevents.*"))
    
    output_files = [summary_file] + tb_files
    
    provenance = {
        "claim_id": "wq_smoke_training_v0",
        "phase": "phase_ii_rl_agent_tcs_infy",
        "tier": "C",
        "snapshot_id": SNAPSHOT_ID,
        "snapshot_rationale": "Used v4 for proper pre-episode history support.",
