"""Train PC-2b (differential_sharpe)."""
...
class DiagnosticsCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        # Shadow evaluation uses eval env running cost_adjusted_pnl
...
def main() -> None:
    ...
    train_env = PC2GymPairsTradingEnv(reward_name="differential_sharpe")
    train_env.reset(seed=42)
    
    # Eval env ALWAYS uses cost_adjusted_pnl as the shadow tracker
    ...
    model = PPO(
        ...
        seed=42,
        verbose=1,
        tensorboard_log=str(out_dir / "tb_pc2b"),
    )
