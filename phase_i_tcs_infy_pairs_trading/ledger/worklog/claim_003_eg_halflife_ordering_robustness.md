...
same-date entry). See `worklog.md` for the index across all labels. This
claim was ADMITTED to `VERIFIED_FACTS.md`; that file holds the final entry,
this file holds the full process history behind it.
